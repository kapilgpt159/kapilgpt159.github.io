...
MessageCardRenderer.prototype.processActionResponse = function(responseJson, callback){
    ...
    try{
        ...
        responseJson["innerErrorCode "] === "ConnectedAccountNotFoundError"){
            ...
            MessageCardRenderer.selectedAction.setStatus(this.buildAuthFailureStatusCard(responseJson["displayMessage"], "https://outlook.office.com" + responseJson.authenticationUrl, "normal", "large"));        
        }
            ...
            MessageCardRenderer.selectedAction.setStatus(this.displayActionStatusMessage(responseJson["displayMessage"]));
        }
        else{
    ...
    if(showGenericError === true){
        MessageCardRenderer.selectedAction.setStatus(this.displayActionStatusMessage("Action could not be completed"));
    }
}
...
function onExecuteAction(action) {
    if (action instanceof AdaptiveCards.ShowCardAction){
        ...
        if(action.url.contains("outlook.office.com/connectors")){
